...
@Component({
  templateUrl: './activity-attachments-list.component.html',
  styleUrls: ['./activity-attachments-list.component.css']
})

export class ActivityAttachmentsListComponent implements OnInit {
  tableLoading = false;
